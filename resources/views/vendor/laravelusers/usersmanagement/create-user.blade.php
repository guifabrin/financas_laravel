                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('email') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('email', NULL, array('id' => 'email', 'class' => 'form-control', 'placeholder' => __('laravelusers::forms.create_user_ph_email'))) !!}
                                    <div class="input-group-append">
                                        <label for="email" class="input-group-text">
                                            @if(config('laravelusers.fontAwesomeEnabled'))
                                                <i class="fa fa-fw {{ __('laravelusers::forms.create_user_icon_email') }}"
                                                   aria-hidden="true"></i>
                                            @else
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('name') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('name', NULL, array('id' => 'name', 'class' => 'form-control', 'placeholder' => __('laravelusers::forms.create_user_ph_username'))) !!}
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="name">
                                            @if(config('laravelusers.fontAwesomeEnabled'))
                                                <i class="fa fa-fw {{ __('laravelusers::forms.create_user_icon_username') }}"
                                                   aria-hidden="true"></i>
                                            @else
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <label class="input-group-text" for="role">
                                                @if(config('laravelusers.fontAwesomeEnabled'))
                                                    <i class="{{ __('laravelusers::forms.create_user_icon_role') }}"
                                                       aria-hidden="true"></i>
                                                @else
                                                    @lang('laravelusers::forms.create_user_label_username')
                                                @endif
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="password">
                                            @if(config('laravelusers.fontAwesomeEnabled'))
                                                <i class="fa fa-fw {{ __('laravelusers::forms.create_user_icon_password') }}"
                                                   aria-hidden="true"></i>
                                            @else
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="password_confirmation">
                                            @if(config('laravelusers.fontAwesomeEnabled'))
                                                <i class="fa fa-fw {{ __('laravelusers::forms.create_user_icon_pw_confirmation') }}"
                                                   aria-hidden="true"></i>
                                            @else
                        ...
                        {!! Form::button(__('laravelusers::forms.create_user_button_text'), array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
