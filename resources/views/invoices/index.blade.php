    ...
    <table class="table table-bordered">
        ...
        @foreach($invoices as $invoice)
            <tr>
                ...
                <td>
                    <button class="btn btn-info btn-iframe" title="{{__('common.import')}} {{__('accounts.account')}}"
                            href="#" data-toggle="modal" data-target="#model_account_{{$invoice->id}}">
                        <i class="fa fa-upload"/></i> {{__('common.import')}}
                    </button>
                </td>
                <td>
                    <button class="btn btn-warning btn-iframe" title="{{__('common.edit')}} {{__('invoices.invoice')}}"
